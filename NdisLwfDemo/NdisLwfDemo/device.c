...
#pragma NDIS_INIT_FUNCTION(NdisLwfDemoRegisterDevice)
    ...
    )
{
    ...
    DEBUGP(DL_TRACE, "==>NdisLwfDemoRegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = NdisLwfDemoDispatch;
    DispatchTable[IRP_MJ_CLEANUP] = NdisLwfDemoDispatch;
    DispatchTable[IRP_MJ_CLOSE] = NdisLwfDemoDispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = NdisLwfDemoDeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==NdisLwfDemoRegisterDevice: %x\n", Status);
