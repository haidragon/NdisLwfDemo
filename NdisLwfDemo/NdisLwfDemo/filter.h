...
#define FILTER_FRIENDLY_NAME        L"NdisLwfDemo NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{7eccb417-8efe-4376-a93c-e035a868ddad}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"NdisLwfDemo"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\NdisLwfDemo"
#define NTDEVICE_STRING             L"\\Device\\NdisLwfDemo"
...
DRIVER_DISPATCH NdisLwfDemoDispatch;

DRIVER_DISPATCH NdisLwfDemoDeviceIoControl;
...
////////////////////////////////////////////////////////////////////////////////////////////
//上面的代码都是Microsoft NDIS Filter框架的。

//下面手工添加 我们自己的程序代码。
//我想添加TCP/IP网络协议的一部分结构体的定义。
